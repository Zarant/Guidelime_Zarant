...
[V]Deposit the following items:\\Seaforium Booster\\Perenolde Tiara\\Tomes of Alterac\\Kravel's Scheme\\Sample Elven Gem --BANKFRAME_OPENED,BAG_UPDATE>>BankD_Badlands40

[T]Train skills\\Train pet skills[O]-->>Map,Ironforge
Turn in [QT1467 Reagents for Reclaimers Inc.][O]
...
[QC2500,1-][O][QC2500,2-][O]Kill wolves/vultures as you quest through Badlands \\Make sure to prioritize vultures-->>Map,Badlands
...
Accept/Turn in [QA705-][QT705 Pearl Diving]\\Skip this step if you don't have 9 pearls
[QT703-][O]Loot Buzzard Wings as you quest
...
Finish off [QC2500] if you haven't
...
Turn in [QT2500 Badlands Reagent Run]-->>Map,Loch Modan
