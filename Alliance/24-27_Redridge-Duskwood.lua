...
function z:Duskwood_End()
	if IsQuestFlaggedCompleted(128) and IsQuestFlaggedCompleted(91) and IsQuestFlaggedCompleted(180) then
		self:LoadNextGuide(1)
	else
		self:LoadNextGuide(2)
	end
end
