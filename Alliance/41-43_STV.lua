...
Turn in [QT193 Panther Mastery]\\Turn in [QT196 Raptor Mastery] \\Accept [QA197 Raptor Mastery]
...
--	local items = {"Gorilla Fangs","Carfully folded note"}
	local items = {2799,4098}
...
function z:BankW1_STV41()  --Perenolde Tiara\\Tomes of Alterac\\Kravel's Scheme\\Sample Elven Gem --BANKFRAME_OPENED,BAG_UPDATE>>BankW_STV41
