...
Get the [P Theramore] FP-->>Map,Dustwallow Marsh
...
Run to Thousand Needles \\Click on the book next to the dead dwarf \\Accept [G30.72,24.34,20Thousand Needles][QA1100 Lonebrow's Journal]-->>Map,Thousand Needles
...
Turn in [QT1135 Highperch Venom]-->>Map,Dustwallow Marsh
...
[A Druid,Mage,Paladin,Priest,Rogue,Hunter,Warrior]Get the [P Ratchet] FP-->>Map,The Barrens
