...
[NX20-22Darkshore/Ashenvale/Stonetalon]
[D Alternative route for non Hunter classes]
[GA Alliance,Warlock,Warrior,Paladin,Priest,Rogue,Mage,Druid]

[T]Train skills[OC]
Fly to [F Redridge Mountains][A Dwarf,Gnome,Human]
Get the [P Stormwind City] flight path[A NightElf]
Leave SW\\Climb the tower of Azora\\Accept [QA94][A NightElf]
[A NightElf]Head to the Redridge/Elwynn border\\Accept [QA244 Encroaching Gnolls]
[A NightElf]Turn in [QT244 Encroaching Gnolls]
...
Guidelime.registerGuide([[
[N20-22Darkshore/Ashenvale/Stonetalon]
[NX22-23Ashenvale/Wetlands]
...
Fly to [F Ashenvale]--OnStepCompletion>>LoadNextGuide
]],"Zarant")
