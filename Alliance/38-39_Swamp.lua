...
Fly to Stormwind[OC]
Accept [QA1448 In Search of The Temple]-->>Map,Stormwind City
...
[G6.59,60.19,90Swamp of Sorrows]Run to Swamp of Sorrows[O]-->>Map,Swamp of Sorrows
...
[G14.97,37.31,70Swamp of Sorrows]Kill some swamp elementals[O]
Finish off [QC1116]
...
Turn in [QT1116] \\Accept [QA1117]-->>Map,Stranglethorn Vale
...
[V]Deposit the following items in your bank:\\Blue Pearls\\Khadgar's Essays on Dimensional Convergence (if you have it) --BANKFRAME_OPENED,BAG_UPDATE>>BankD_Swamp38
...
Turn in [QT1457 The Karnitol Shipwreck] -->>Map,Ironforge
